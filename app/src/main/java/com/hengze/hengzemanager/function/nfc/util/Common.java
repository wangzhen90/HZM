...
package com.hengze.hengzemanager.function.nfc.util;
...
public class Common extends Application {
     ...
     * the main activity
     * ({ de.syss.MifareClassicTool.Activities.MainMenu}).
     * (sub directory of {@link #HOME_DIR}.)
     */
     ...
     * { de.syss.MifareClassicTool.Activities.KeyMapCreator}
...
// ############################################################################
    ...
    public static MCReader checkForTagAndCreateReader(Context context) {
        ...
        Toast.makeText(context,"The tag is gone",
                Toast.LENGTH_LONG).show();
        return null;
    }
