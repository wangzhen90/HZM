...
//    http://118.183.190.176:8082/HzmoFrame/find.wellan?wellID=0994010101002
    ...
    @GET("/find.wellan")
    void queryWellDetail(@Query("wellID") String wellID, Callback<ArrayList<WellDetail>> callback);
    ...
    @POST("/modify.wellan")
    void testUpdate(@Body WellDetail wellDetail, Callback<WellDetail> callback);

    @FormUrlEncoded
    @POST("/modify.wellan")
    void testUpdate2(@Field("wellName") String wellName, Callback<WellDetail> callback);
}
